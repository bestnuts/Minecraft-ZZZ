...
function animated_java:anby_demara/root/outdated_tellraw with storage aj:temp
data modify entity @s data.rigHash set value 'b0ae8cb06cbf517e83a45281a9f6d6ee789ac204ed106cda46b65a6b5878ff7a'
